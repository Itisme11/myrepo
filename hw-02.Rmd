...
```{r}
wizards["Fred"] <- c("Hermione")
wizards
wizards["George"]<-c("Ginny")
wizards
wizards["Sirius"]<-c("Malfoy")
wizards
```
...
```{r}
wizards <- c ("Lead=Ginny","Friend = Ron","Friend=Hermione","Wife =Malfoy","Rival=Harry")
wizards
```
